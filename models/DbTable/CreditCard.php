...
class Application_Model_DbTable_CreditCardRow extends Zend_Db_Table_Row_Abstract {
    
}

class Application_Model_DbTable_CreditCard extends Zend_Db_Table_Abstract {

    protected $_name = 'wa_users_credit_card';
    protected $_id = 'id';
    protected $_rowClass = "Application_Model_DbTable_CreditCardRow";
