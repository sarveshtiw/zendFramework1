    <?php
class SecretGroupsController extends My_Controller_Abstract{
    ...
    public function createGroupAction(){
       // $this->createQuickBloxGroup('132','group123', array('55042','55040'));die();
        ...
        if($userSecurity == $this->servicekey){
            $this->common->checkEmptyParameter1(array($userSecurity,$userId,$userDeviceId,$groupName,$adminSecretName,$memberPassword,$requestMemberStr));
            ...
            if($userRow = $userTable->getRowById($userId)){
                ...
                if(($secGroupRow = $secGroupTable->getRowByUserIdAndGroupName($userId, $groupName)) && ($secGroupRow->status == "1")){
                    ...
                    if(count($requestMemberSet)){
                       ...
                       $reponseData[] = array(
                        ...
                        $response = array(
                            'response_string'       => 'Secret group created successfully',
                            'error_code'            => '0',
                            'response_error_key'    => '0',
                            'groupId'               => ($secGroupRow->secGroupId)?$secGroupRow->secGroupId:"",
                            ...
                            'memberPassword'        => $secGroupMemberRow->memberPassword,
                            ...
                            'member_status'         => ($secGroupRow->status)?"1":"0",
                            'result'                => $reponseData
                        );
    ...
    public function addMembersAction(){
        ...
        $userDeviceId = $decoded['userDeviceId']; $this->getRequest()->getPost('userDeviceId','');
    ...
    public function updateGroupDetailsAction(){
        ...
        $secretGroupImage = $_FILES['secretGroupImage'];
        $memberPassword = $this->getRequest()->getPost('memberPassword','');
                ...
                if($secGroupMemberRow = $secGroupMemberTable->getRowByMemberIdAndGroupId($userId, $secretGroupId)){
                        if($secretGroupRow = $secGroupTable->getRowById($secretGroupId)){
                            ...
                            */
                            ...
                            $data = array(
                                'groupId'           => $secretGroupRow->secGroupId,
                                'is_admin'          => ($secretGroupRow->adminId == $userId)?"1":"0",
                                'adminId'           => ($secretGroupRow->adminId)?$secretGroupRow->adminId:"",
                            ...
                            $responseData = array(
                                 "response_string"      => "Update details successfully",
                                 "error_code"           => "0",
                                 "response_error_key"   => "0",
                                 "modifyDate"           => $secretGroupRow->modifyDate,
                                 "result"               => $data
                            ...
                            $this->common->displayMessage("Update details successfully","0",$data,"0");
